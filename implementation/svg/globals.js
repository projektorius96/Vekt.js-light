...
const
    ...
    GLOBAL_SCALAR = 1 /* range := [1..4], ideally, trivial value would be zero (0), this would visually hide shapes that dependent on the constant, but it would not opt-out from rendering pipeline (switch statement) */
    ,
